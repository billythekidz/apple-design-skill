...
**Source**: [Apple Developer Documentation - Searching](https://developer.apple.com/design/human-interface-guidelines/searching)

---



![A sketch of a magnifying glass, suggesting the search for information. The image is overlaid with rectangular and circular grid lines and is tinted orange to subtly reflect the orange in the original six-color Apple logo.](./images/searching/patterns-searching-intro_2x.png)
