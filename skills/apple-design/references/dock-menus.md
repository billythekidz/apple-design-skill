...
**Source**: [Apple Developer Documentation - Dock menus](https://developer.apple.com/design/human-interface-guidelines/dock-menus)

---



![A stylized representation of a menu extending from an icon in the Dock. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](./images/dock-menus/components-dock-menu-intro_2x.png)
